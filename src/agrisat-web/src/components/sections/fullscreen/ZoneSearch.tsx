...
export const ZoneSearch = memo(function ZoneSearch({ levels, zones }: ZoneSearchProps) {
	...
	useEffect(() => {
		...
		if (!list) return;
		const item = list.querySelector<HTMLElement>(`[data-idx="${highlightedIdx}"]`);
	...
	const handleKeyDown = useCallback(
		...
		[filteredZones, highlightedIdx, handleSelectZone, handleClose, handleTabLevel],
	);
										...
										<Item key={zone.zone_id} asChild>
											...
											>
												...
												<ItemContent>
													...
													<ItemDescription>
														{zone.city} · {(zone.area / 1_000_000).toFixed(2)} km²
													</ItemDescription>
												</ItemContent>
												<ItemActions>
													<Badge
